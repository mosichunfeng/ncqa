                    ...
                    <div class="panel-body">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="${basePath}/excel/学生上传模板.xlsx" download="学生上传模板.xlsx" class="btn btn-sm btn-info">下载批量添加模板</a>
                                <a href="javascript:void(0)"  onclick="uploadExcelFile()" class="btn btn-sm btn-primary upload-subject">上传学生</a>
...
<script>
    ...
    function onRead(object) {
        ...
        formData.append('studentClassId', $("#selecter").val());
        var req = new XMLHttpRequest();
        req.open("post", "${basePath}/student/upload", true);
