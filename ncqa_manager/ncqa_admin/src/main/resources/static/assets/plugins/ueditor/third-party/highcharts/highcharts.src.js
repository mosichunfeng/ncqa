...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} color The color or cn.neusoft.xuxiao.config object
	 */
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same cn.neusoft.xuxiao.config object is created within this renderer
			if (gradients[key]) {
				id = gradients[key].id;
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a special cn.neusoft.xuxiao.config object for the label.
	 */
...
Chart.prototype = {
	 ...
	 *
	 * @param {Object} options The cn.neusoft.xuxiao.config options
	...
	/**
	 * Create the Axis instances based on the cn.neusoft.xuxiao.config options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original cn.neusoft.xuxiao.config options for
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// a specific marker cn.neusoft.xuxiao.config object is defined for the individual point:
			...
			// no marker cn.neusoft.xuxiao.config object is created: copy a reference to the series-wide
