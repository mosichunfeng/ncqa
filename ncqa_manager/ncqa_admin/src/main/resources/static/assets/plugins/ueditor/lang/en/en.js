...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server cn.neusoft.xuxiao.config not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server cn.neusoft.xuxiao.config error.',
    'loadconfigFormatError': 'Server cn.neusoft.xuxiao.config format error.',
    'loadconfigHttpError': 'Get server cn.neusoft.xuxiao.config http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the cn.neusoft.xuxiao.config!",
