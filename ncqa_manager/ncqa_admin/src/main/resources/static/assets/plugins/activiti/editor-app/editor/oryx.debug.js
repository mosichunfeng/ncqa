...
ORYX.CONFIG.TEST_SERVICE_URL = 				ORYX.CONFIG.SERVER_HANDLER_ROOT + "/cn.neusoft.xuxiao.service/";
...
ORYX = Object.extend(ORYX, {
	...
	//set the path in the cn.neusoft.xuxiao.config.js file!!!!
	PATH: ORYX.CONFIG.ROOT_PATH,
	//CONFIGURATION: "cn.neusoft.xuxiao.config.js",
	 ...
	 * yet loaded, cn.neusoft.xuxiao.config.js is being requested from the server. A repeated
...
function init() {
    ...
    // Else fetch the model from server and display editor
		...
		var modelUrl = "./cn.neusoft.xuxiao.service/model/" + modelId + "/json";
 ...
 * @param {Object} cn.neusoft.xuxiao.config Editor cn.neusoft.xuxiao.config passed to the constructur, merged with the response of the request to modelUrl
 */
	  										...
	  										if (ref == "pimg") {
	  											...
	  											if(onclickAttr) {
	  												if(prop && ("" + prop).length > 0) {
	  													onclickAttr.textContent = "window.location = '../cn.neusoft.xuxiao.service/editor?id=" + prop + "_form'";
	  							    	   			} else {
